 ...
 * @author internet
 */
@WebServlet(name = "CadastrarPagamento", urlPatterns = {"/CadastrarPagamento"})
public class CadastrarPagamento extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Pagamento pag = new Pagamento(nomeDespesa, valor, dataVencimento, dataAgendamento, 0);
        
        DaoPagamento daoPagamento = new DaoPagamento();
        if (daoPagamento.save(pag)){
            response.sendRedirect("cadastroDespesa.jsp");
        }else{
            response.sendRedirect("errocadastroDespesa.jsp");
        }        
